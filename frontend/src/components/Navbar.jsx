...
function Navbar() {
  ...
  const navitems = (
    <>
      ...
      <li key="products"><a href="/product">Products</a></li>
      <li key="contact"><a href="/contact_us">Contact Us</a></li>
      ...
      >
        <div className="navbar flex items-center justify-between">
          <div className="navbar-start flex items-center">
            ...
            <a className="text-4xl font-bold">NAMOH Spices</a>
          </div>
          ...
          <div className="navbar-end flex items-center space-x-3">
            ...
            {authUser ? (
              ...
              <div className= " " >
              <a
                className="bg-black text-white px-4 py-1 rounded-md hover:bg-slate-800 duration-300 cursor-pointer"
